                            ...
                            <div class="container z-10">
                                <div class="flex flex-wrap justify-center -mx-3">
                                    <div class="w-full max-w-full px-3 mx-auto mt-0 text-center lg:flex-0 shrink-0 lg:w-5/12">
                                        ...
                                        <p class="text-white">
                                            You have login or signup! create new
                                        ...
                                        <div class="flex-auto p-6">
                                            ...
                                            >
                                                ...
                                                <div class="min-h-6 pl-6.92-em mb-0.5 block">
                                                    <input
                                                        id="terms"
                                                        class="w-4 h-4  ease-soft -ml-6.92-em rounded-1.4 relative float-left mt-1 cursor-pointer border border-solid  bg-white  bg-center bg-no-repeat align-top transition-all after:absolute after:flex after:h-full after:w-full after:items-center after:justify-center after:text-white border-gray-900 after:opacity-0 after:transition-all  "
                                                        type="checkbox"
                                                    />
                                                    <label
                                                ...
                                                <p class="mt-4 mb-0 leading-normal text-size-sm">
